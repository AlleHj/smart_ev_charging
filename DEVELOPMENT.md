...
**Namn på denna komponent:** `smart_ev_charging`
...
```bash
ln -s /workspaces/homeassistcore/config/smart_ev_charging/custom_components/smart_ev_charging /workspaces/homeassistcore/config/custom_components/
```
...
```bash
unlink /workspaces/homeassistcore/config/custom_components/smart_ev_charging
```
